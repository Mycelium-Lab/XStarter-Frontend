    ...
    <div className={css(styles.bgnavbar)}>
      <div className={css(styles.flex1, styles.flex1_layout)}>
        ...
        <div className={css(styles.flex1_col1)}>
          ...
          <Link className={props.location.pathname == '/Idos' ? css(styles.staking, styles.staking_layout, styles.active_path) : css(styles.staking, styles.staking_layout)} to="/Idos">Projects</Link>
        </div>
        <div className={css(styles.flex1_spacer1)} />
        <div className={css(styles.flex1_col2)}>
          <Link className={props.location.pathname == '/Staking' ? css(styles.staking, styles.staking_layout, styles.active_path) : css(styles.staking, styles.staking_layout)} to="/Staking">Staking</Link>
        </div>
        <div className={css(styles.flex1_spacer2)} />
        <div className={css(styles.flex1_col3)}>
          <Link className={props.location.pathname == '/TradingXS' ? css(styles.staking, styles.staking_layout, styles.active_path) : css(styles.staking, styles.staking_layout)} to="/TradingXS">Trade XS</Link>
...
const styles = StyleSheet.create({
  active_path: {
    textDecoration: 'underline #00b682'
  },
  group: {
    display: 'flex',
